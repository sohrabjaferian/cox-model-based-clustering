### This script can generates a 2-cluster data, each cluster has 3 true fixed effects and 2 true random effects
...
save(data1, file = "sim_LMM_fixed_clusters.RData")
write.csv(data1, "sim_LMM_fixed_clusters.csv", row.names = FALSE)
